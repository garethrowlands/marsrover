...
spec :: Spec
spec = fromHUnitTest parserTests
...
parseRoverInputTests = mkParserTests "input for a single rover" p_roverInput [
        ("1 1 N\nLRM",
         Right $ RoverInput {
...
parseOverallInputTest = mkParserTests "complete acceptance test input" p_overallInput [
